              ...
              <div className="flex-1">
                ...
                <div className="mt-4 space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-gray-700 pl-6">{profile.bio}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-700 pl-6">{profile.phone}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-1 pl-6">
                      {profile.expertise.split(",").map((skill, index) => (
                        <span
                          key={index}
                          className="inline-block bg-blue-50 text-blue-700 text-sm px-3 py-1 rounded-full mr-2 mb-2"
                        >
                          {skill.trim()}
                        </span>
                      ))}
